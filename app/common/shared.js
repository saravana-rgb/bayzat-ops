...
.hello h2{font-size:22px;font-weight:600;letter-spacing:-.5px}
.hello p{font-size:13.5px;color:var(--ink3);margin-top:7px;display:flex;gap:14px;
  align-items:baseline;flex-wrap:wrap}
.kbd-hint{margin-left:auto;font-size:12px;color:var(--ink3)}
kbd{font:500 11px var(--font);background:var(--surface);border:1px solid var(--line);
  border-bottom-width:2px;border-radius:4px;padding:2px 6px;color:var(--ink2)}

.today{display:grid;gap:8px;margin-bottom:28px}
.job{display:flex;align-items:center;gap:13px;background:var(--surface);
  border:1px solid var(--line);border-left:3px solid var(--line);
  border-radius:0 var(--r-lg) var(--r-lg) 0;padding:13px 16px;
  transition:all .15s var(--ease)}
.job:hover{border-color:var(--ink3);transform:translateX(2px)}
.job.rose{border-left-color:var(--rose)} .job.rose:hover{border-color:var(--rose)}
.job.amber{border-left-color:var(--amber)} .job.amber:hover{border-color:var(--amber)}
.job.blue{border-left-color:var(--s1)} .job.blue:hover{border-color:var(--s1)}
.jdot{width:7px;height:7px;border-radius:50%;background:currentColor;flex:none;opacity:.5}
.job.rose .jdot{color:var(--rose)} .job.amber .jdot{color:var(--amber)}
.job.blue .jdot{color:var(--s1)}
.jbody{flex:1;min-width:150px;display:grid;gap:3px}
.jwhat{font-size:14px;font-weight:600;color:var(--ink)}
.jwhy{font-size:12.5px;color:var(--ink3)}
.jgo{color:var(--ink3);font-size:15px;flex:none}
.job:hover .jgo{color:var(--ink)}
